...
public class driveCurve extends Command {
	...
	public driveCurve(double driveLeftTarget,double driveRightTarget,double steeringTarget) {
    ...
    protected void execute() {
    	if (Math.abs(RobotMap.driveLeft1.getPosition())<Math.abs(25)){
            this.steering.setDesiredValue(0);
    	}
    	else if (Math.abs(RobotMap.driveLeft1.getPosition())<Math.abs(50)){
            this.steering.setDesiredValue(90);
    	}
    	else if (Math.abs(RobotMap.driveLeft1.getPosition())<Math.abs(75)){
            this.steering.setDesiredValue(90);
    	}
